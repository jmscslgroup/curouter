! function (t) {
	...
	return function e(t, n, i) {
		...
		1: [function (t, e, n) {
			...
			"turf-planepoint": 74,
			"turf-point-grid": 75,
			"turf-point-on-line": 76,
			"turf-point-on-surface": 77,
			"turf-random": 78,
			"turf-sample": 80,
			"turf-simplify": 81,
			"turf-square": 84,
		...
		14: [function (e, n, i) {
			! function (e, r) {
				"object" == typeof i && "undefined" != typeof n ? r(i) : "function" == typeof t && t.amd ? t(["exports"], r) : r(e.jsts = e.jsts || {})
			}(this, function (t) {
				"use strict";
				...
				function I() {
					this.array_ = [], arguments[0] instanceof p && this.addAll(arguments[0])
				}
				...
				function fn() {
					if (this.elt = new Array(2).fill(null), 1 === arguments.length) {
						...
						var n = arguments[0],
							i = arguments[1];
						this.elt[0] = new gn(L.NONE), this.elt[1] = new gn(L.NONE), this.elt[n].setLocation(i)
					} else if (3 === arguments.length) {
						var r = arguments[0],
							s = arguments[1],
							o = arguments[2];
						this.elt[0] = new gn(r, s, o), this.elt[1] = new gn(r, s, o)
					} else if (4 === arguments.length) {
						var a = arguments[0],
							u = arguments[1],
							l = arguments[2],
				...
				function Ii() {
					this.result = null, this.factory = null, this.graph = null, this.lines = new I, this.nodeEdgeStack = new me, this.ringStartEdge = null, this.graph = new Ei
				}
				...
				function Ti() {
					this.root = null, this.minExtent = 1, this.root = new bi
				}
				...
				function Oi(t) {
					this.geometryFactory = t || new ie, this.precisionModel = this.geometryFactory.getPrecisionModel(), this.parser = new Pi(this.geometryFactory)
				}

				function Mi() {
					this.parser = new Pi(this.geometryFactory)
				}
				...
				function fr() {
					gr.apply(this), this.parentEdge = null, this.from = null, this.to = null, this.p0 = null, this.p1 = null, this.sym = null, this.edgeDirection = null, this.quadrant = null, this.angle = null;
					var t = arguments[0],
						e = arguments[1],
						n = arguments[2],
						i = arguments[3];
				...
				function Er() {
					this.edges = new Q, this.dirEdges = new Q, this.nodeMap = new xr
				}
				...
				function kr() {
					qr.apply(this), this.rectEnv = null, this.rectIntersector = null, this.hasIntersection = !1, this.p0 = new f, this.p1 = new f;
					var t = arguments[0];
				...
				function Vs() {
					if (this.ls = null, this.data = null, 2 === arguments.length) {
						...
						var s = arguments[0],
							...
							l = arguments[4],
							h = arguments[5];
						Vs.call(this, new f(s, o, a), new f(u, l, h))
				...
				Ks.prototype.next = function () {
					...
					divide: function () {
						...
						if ("number" == typeof arguments[0]) {
							var g = arguments[0];
							return r.isNaN(g) ? M.createNaN() : M.copy(this).selfDivide(g, 0)
						}
					},
					ge: function (t) {
						return this.hi > t.hi || this.hi === t.hi && this.lo >= t.lo
				...
				}), A.X = 0, A.Y = 1, A.Z = 2, A.M = 3, D.arraycopy = function (t, e, n, i, r) {
					...
					if (5 === arguments.length)
						for (var i = arguments[0], r = arguments[1], s = arguments[2], o = arguments[3], a = arguments[4], n = 0; a > n; n++) s[o + n] = new f(i[r + n])
				...
				eo.prototype.next = function () {
				...
				}), gt.serialVersionUID = -0x4f07bcb1f857d800, h(ft, gt), e(ft.prototype, {
					getSortIndex: function () {
					...
					addEndpoint: function (t) {
						...
						null === e && (e = new mt, this.endpointMap.put(t, e)), e.count++
					},
					interfaces_: function () {
						return []
					},
					...
					if (2 === arguments.length) {
						for (var i = arguments[0], r = arguments[1], s = "", o = new vt(Nt.getStackTrace(i)), a = new It(o), u = 0; r > u; u++) try {
				...
				}), bt.serialVersionUID = -0x307ffefd8dc97200, h(Tt, gt), e(Tt.prototype, {
					getSortIndex: function () {
				...
				}), Pt.MINIMUM_VALID_SIZE = 4, Pt.serialVersionUID = -0x3b229e262367a600, h(Ot, gt), e(Ot.prototype, {
					getSortIndex: function () {
					...
					editGeometryCollection: function (t, e) {
						...
						return n.getClass() === Tt ? this.factory.createMultiPoint(i.toArray([])) : n.getClass() === ft ? this.factory.createMultiLineString(i.toArray([])) : n.getClass() === Ot ? this.factory.createMultiPolygon(i.toArray([])) : this.factory.createGeometryCollection(i.toArray([]))
					},
				...
				e(se.prototype, {
					...
					intersection: function (t, e, n, i) {
						...
						return this.isInSegmentEnvelopes(r) || (r = new f(ae.nearestEndpoint(t, e, n, i))), null !== this.precisionModel && this.precisionModel.makePrecise(r), r
					},
					...
					computeIntersect: function (t, e, n, i) {
						...
						return u ? this.computeCollinearIntersection(t, e, n, i) : (0 === r || 0 === s || 0 === o || 0 === a ? (this._isProper = !1, t.equals2D(n) || t.equals2D(i) ? this.intPt[0] = t : e.equals2D(n) || e.equals2D(i) ? this.intPt[0] = e : 0 === r ? this.intPt[0] = new f(n) : 0 === s ? this.intPt[0] = new f(i) : 0 === o ? this.intPt[0] = new f(t) : 0 === a && (this.intPt[0] = new f(e))) : (this._isProper = !0, this.intPt[0] = this.intersection(t, e, n, i)), oe.POINT_INTERSECTION)
					},
					interfaces_: function () {
						return []
					},
				...
				}, ce.serialVersionUID = 0x2d2172135f411c00, e(ge.prototype, {
				...
				e(fe.prototype, {
				...
				}, de.prototype = new Error, de.prototype.name = "EmptyStackException", me.prototype = new y, me.prototype.add = function (t) {
					return this.array_.push(t), !0
					...
					return this.empty()
				}, me.prototype.search = function (t) {
					...
					snapVertices: function (t, e) {
						for (var n = this._isClosed ? t.size() - 1 : t.size(), i = 0; n > i; i++) {
							...
							null !== s && (t.set(i, new f(s)), 0 === i && this._isClosed && t.set(t.size() - 1, new f(s)))
						}
					},
					...
					locateInternal: function () {
						...
						if (arguments[0] instanceof f && arguments[1] instanceof Lt) {
							var h = arguments[0],
								c = arguments[1],
								g = c.getCoordinate();
							return g.equals2D(h) ? L.INTERIOR : L.EXTERIOR
						}
					},
				...
				e(qe.prototype, {
						...
						if (1 === arguments.length) {
							for (var e = arguments[0], n = new I, i = e.getChildBoundables().iterator(); i.hasNext();) {
								...
								if (r instanceof Ge) {
									...
									null !== s && n.add(s)
								} else r instanceof _e ? n.add(r.getItem()) : g.shouldNeverReachHere()
							}
						...
						if (2 === arguments.length) {
							...
							if (R(arguments[2], De) && arguments[0] instanceof Object && arguments[1] instanceof Ge)
								for (var r = arguments[0], s = arguments[1], o = arguments[2], a = s.getChildBoundables(), u = 0; u < a.size(); u++) {
									var l = a.get(u);
									this.getIntersectsOp().intersects(l.getBounds(), r) && (l instanceof Ge ? this.query(r, l, o) : l instanceof _e ? o.visitItem(l.getItem()) : g.shouldNeverReachHere())
									...
									for (var h = arguments[0], c = arguments[1], f = arguments[2], a = c.getChildBoundables(), u = 0; u < a.size(); u++) {
										var l = a.get(u);
										this.getIntersectsOp().intersects(l.getBounds(), h) && (l instanceof Ge ? this.query(h, l, f) : l instanceof _e ? f.add(l.getItem()) : g.shouldNeverReachHere())
									}
					},
					build: function () {
					...
					createSplitEdge: function (t, e) {
						...
						return r && (s[o] = new f(e.coord)), new Ze(s, this.edge.getData())
					},
					add: function (t, e) {
						var n = new Xe(this.edge, t, e, this.edge.getSegmentOctant(e)),
							i = this.nodeMap.get(n);
						return null !== i ? (g.isTrue(i.coord.equals2D(t), "Found equal nodes with different coordinates"), i) : (this.nodeMap.put(n, n), n)
					},
				...
				}, cn.ON = 0, cn.LEFT = 1, cn.RIGHT = 2, e(gn.prototype, {
					...
					matchInSameDirection: function (t, e, n, i) {
						return t.equals(n) ? he.computeOrientation(t, e, i) === he.COLLINEAR && Qe.quadrant(t, e) === Qe.quadrant(n, i) : !1
					},
					...
					collectBoundaryTouchEdge: function (t, e, n) {
						var i = t.getLabel();
						return t.isLineEdge() ? null : t.isVisited() ? null : t.isInteriorAreaEdge() ? null : t.getEdge().isInResult() ? null : (g.isTrue(!(t.isInResult() || t.getSym().isInResult()) || !t.getEdge().isInResult()), void(ii.isResultOfOp(i, e) && e === ii.INTERSECTION && (n.add(t.getEdge()), t.setVisitedEdge(!0))))
					},
					interfaces_: function () {
						return []
					},
						...
						for (var s = e, n = this.iterator(); n.hasNext();) {
							...
							if (r.getLocation(t, cn.ON) === L.NONE && r.setLocation(t, cn.ON, s), r.isArea(t)) {
								...
								if (a !== L.NONE) {
									...
									o === L.NONE && g.shouldNeverReachHere("found single null side (at " + i.getCoordinate() + ")"), s = o
								} else g.isTrue(r.getLocation(t, cn.LEFT) === L.NONE, "found single null side"), r.setLocation(t, cn.RIGHT, s), r.setLocation(t, cn.LEFT, s)
							}
						}
					},
					getCoordinate: function () {
					...
					getRightmostEdge: function () {
						...
						var i = t.get(e - 1),
							r = n.getQuadrant(),
							s = i.getQuadrant();
						return Qe.isNorthern(r) && Qe.isNorthern(s) ? n : Qe.isNorthern(r) || Qe.isNorthern(s) ? 0 !== n.getDy() ? n : 0 !== i.getDy() ? i : (g.shouldNeverReachHere("found two horizontal edges incident on node"), null) : i
					},
					print: function (t) {
					...
					linkMinimalDirectedEdges: function (t) {
						...
						i === this.LINKING_TO_OUTGOING && (g.isTrue(null !== e, "found null for first outgoing dirEdge"), g.isTrue(e.getEdgeRing() === t, "unable to link last incoming dirEdge"), n.setNextMin(e))
					},
					...
					createSplitEdge: function (t, e) {
						...
						return r && (s[o] = e.coord), new Qn(s, new fn(this.edge.label))
					},
					add: function (t, e, n) {
						var i = new Wn(t, e, n),
					...
					computeIntersectsForChain: function () {
						if (4 === arguments.length) {
							...
							var d = Math.trunc((r + s) / 2),
								m = Math.trunc((a + u) / 2);
							d > r && (m > a && this.computeIntersectsForChain(r, d, o, a, m, l), u > m && this.computeIntersectsForChain(r, d, o, m, u, l)), s > d && (m > a && this.computeIntersectsForChain(d, s, o, a, m, l), u > m && this.computeIntersectsForChain(d, s, o, m, u, l))
						}
					},
				...
				}, Kn.NULL_VALUE = -1, h(Qn, vn), e(Qn.prototype, {
					getDepth: function () {
						return this.depth
					},
					...
					computeLabelsFromDepths: function () {
						for (var t = this.edgeList.iterator(); t.hasNext();) {
							...
							if (!i.isNull()) {
								i.normalize();
								for (var r = 0; 2 > r; r++) n.isNull(r) || !n.isArea() || i.isNull(r) || (0 === i.getDelta(r) ? n.toLine(r) : (g.isTrue(!i.isNull(r, cn.LEFT), "depth of LEFT side has not been initialized"), n.setLocation(r, cn.LEFT, i.getLocation(r, cn.LEFT)), g.isTrue(!i.isNull(r, cn.RIGHT), "depth of RIGHT side has not been initialized"), n.setLocation(r, cn.RIGHT, i.getLocation(r, cn.RIGHT))))
							}
						}
					},
					...
					return new f(oi.avg(t.getMinX(), t.getMaxX()), oi.avg(t.getMinY(), t.getMaxY()))
				}, oi.avg = function (t, e) {
					return (t + e) / 2
				}, e(ai.prototype, {
					...
					add: function () {
						if (arguments[0] instanceof B) {
							...
							r < this.minDistance && (this.interiorPoint = new f(i), this.minDistance = r)
						}
					},
					interfaces_: function () {
						return []
				...
				}), gi.pointWitMinAngleWithX = function (t, e) {
					...
					return i
				}, gi.lowestPoint = function (t) {
					for (var e = t[0], n = 1; n < t.length; n++) t[n].y < e.y && (e = t[n]);
					return e
				}, gi.pointWithMinAngleWithSegment = function (t, e, n) {
				...
				}), fi.nextIndex = function (t, e) {
					return e++, e >= t.length && (e = 0), e
				}, fi.computeC = function (t, e, n) {
					return t * n.y - e * n.x
				}, fi.getMinimumDiameter = function (t) {
					return new fi(t).getDiameter()
				}, fi.getMinimumRectangle = function (t) {
					return new fi(t).getMinimumRectangle()
				}, fi.computeSegmentForLine = function (t, e, n) {
					var i = null,
						r = null;
				...
				var co = Object.freeze({
					...
					MinimumBoundingCircle: gi,
					MinimumDiameter: fi
				});
				e(di.prototype, {
					getResultGeometry: function () {
						return new mi(this.distanceTolerance).transform(this.inputGeom)
					},
				...
				e(pi.prototype, {
				...
				}), vi.setMarkBoth = function (t, e) {
					t.setMark(e), t.sym().setMark(e)
				}, vi.isMarked = function (t) {
					return t.isMarked()
				}, vi.setMark = function (t, e) {
					t.setMark(e)
				}, vi.markBoth = function (t) {
					t.mark(), t.sym().mark()
				}, vi.mark = function (t) {
					t.mark()
				}, e(yi.prototype, {
					...
					buildLine: function (t) {
						var e = new N,
							n = t;
						for (this.ringStartEdge = null, vi.markBoth(n), e.add(n.orig().copy(), !1); 2 === n.sym().degree();) {
					...
					stackEdges: function (t) {
						var e = t;
						do vi.isMarked(e) || this.nodeEdgeStack.add(e), e = e.oNext(); while (e !== t)
					},
					...
					buildLines: function () {
						for (; !this.nodeEdgeStack.empty();) {
							...
							vi.isMarked(t) || this.buildLine(t)
						}
					},
					add: function () {
						if (arguments[0] instanceof B) {
				...
				}), bi.origin = new f(0, 0), e(Ti.prototype, {
					size: function () {
				...
				e(Oi.prototype, {
					...
					reducePrecision: function (t) {
						if (t.coordinate) this.precisionModel.makePrecise(t.coordinate);
							...
							for (var i = 0, r = t.geometries.length; r > i; i++) this.reducePrecision(t.geometries[i])
					}
				}), e(Di.prototype, {
					read: function (t) {
					...
					convertToMultiPoint: function (t) {
						return new ol.geom.MultiPoint(t.getCoordinates().map(Ai))
					},
				...
				e(Gi.prototype, {
					...
					init: function (t) {
						this.distance = t, this.maxCurveSegmentError = t * (1 - Math.cos(this.filletAngleQuantum / 2)), this.segList = new Yi, this.segList.setPrecisionModel(this.precisionModel), this.segList.setMinimumVertexDistance(t * Xi.CURVE_VERTEX_SNAP_DISTANCE_FACTOR)
					},
							...
							if (R(arguments[2], y) && arguments[0] instanceof f && arguments[1] instanceof In)
								for (var s = arguments[0], o = arguments[1], a = arguments[2], u = o.getEdge().getCoordinates(), n = 0; n < u.length - 1; n++) {
									...
									for (var g = arguments[0], d = arguments[1], m = arguments[2], n = d.iterator(); n.hasNext();) {
										var p = n.next();
										p.isForward() && this.findStabbedSegments(g, p, m)
									}
					},
					getDepth: function (t) {
				...
				}), Ji.isAdjacentSegments = function (t, e) {
					return 1 === Math.abs(t - e)
				}, e(Ki.prototype, {
					...
					checkInteriorIntersections: function () {
						if (0 === arguments.length)
							...
							if (this.li.computeIntersection(m, p, v, y), this.li.hasIntersection() && (this.li.isProper() || this.hasInteriorIntersection(this.li, m, p) || this.hasInteriorIntersection(this.li, v, y))) throw new l("found non-noded intersection at " + m + "-" + p + " and " + v + "-" + y)
						}
					},
					checkValid: function () {
					...
					checkCollapse: function (t, e, n) {
						if (t.equals(n)) throw new l("found non-noded collapse at " + Qi.fact.createLineString([t, e, n]))
					},
					interfaces_: function () {
						return []
					},
				...
				e(or.prototype, {
					...
					if (2 === arguments.length) {
						var e = arguments[0],
							n = arguments[1];
						return e instanceof bt ? n.add(e) : e instanceof gt && e.apply(new or(n)), n
					}
				}, e(ar.prototype, {
					...
					if (2 === arguments.length) {
						var e = arguments[0],
							n = arguments[1];
						return e instanceof Lt ? n.add(e) : e instanceof gt && e.apply(new ur(n)), n
					}
				}, e(lr.prototype, {
					filter: function (t) {
						(t instanceof Lt || t instanceof wt || t instanceof bt) && this.locations.add(new ar(t, 0, t.getCoordinate()))
					},
					interfaces_: function () {
						return [ht]
					},
					...
					computeContainmentDistance: function () {
						if (0 === arguments.length) {
							...
							} else if (arguments[2] instanceof Array && arguments[0] instanceof ar && arguments[1] instanceof bt) {
							var g = arguments[0],
								f = arguments[1],
								d = arguments[2],
								m = g.getCoordinate();
				...
				e(cr.prototype, {
				...
				}), gr.getComponentWithVisitedState = function (t, e) {
					for (; t.hasNext();) {
						var n = t.next();
						if (n.isVisited() === e) return n
					}
					return null
				}, gr.setVisited = function (t, e) {
					for (; t.hasNext();) {
						var n = t.next();
						n.setVisited(e)
					}
				}, gr.setMarked = function (t, e) {
					for (; t.hasNext();) {
						var n = t.next();
						n.setMarked(e)
					}
				}, h(fr, gr), e(fr.prototype, {
					isRemoved: function () {
					...
					getNode: function (t) {
						...
						return null === e && (e = new vr(t), this.add(e)), e
					},
					interfaces_: function () {
						return []
					},
				...
				h(Cr, fr), e(Cr.prototype, {
					...
					null !== r && (g.isTrue(null !== i), r.setNext(i))
					...
					do {
						var r = n.getFromNode();
						Rr.getDegree(r, e) > 1 && (null === i && (i = new I), i.add(r)), n = n.getNext(), g.isTrue(null !== n, "found null DE in ring"), g.isTrue(n === t || !n.isInRing(), "found DE already in ring")
					} while (n !== t);
					return i
				}, e(br.prototype, {
					getGeometry: function () {
				...
				}), Ur.covers = function (t, e) {
					return t.getEnvelopeInternal().covers(e.getEnvelopeInternal()) ? t.isRectangle() ? !0 : Ur.relate(t, e).isCovers() : !1
				}, Ur.intersects = function (t, e) {
					return t.getEnvelopeInternal().intersects(e.getEnvelopeInternal()) ? t.isRectangle() ? Br.intersects(t, e) : e.isRectangle() ? Br.intersects(e, t) : Ur.relate(t, e).isIntersects() : !1
				}, Ur.touches = function (t, e) {
					return t.getEnvelopeInternal().intersects(e.getEnvelopeInternal()) ? Ur.relate(t, e).isTouches(t.getDimension(), e.getDimension()) : !1
				}, Ur.within = function (t, e) {
					return e.contains(t)
				}, Ur.coveredBy = function (t, e) {
					return Ur.covers(e, t)
				}, Ur.relate = function () {
					if (2 === arguments.length) {
						var t = arguments[0],
							e = arguments[1],
				...
				}, Ur.overlaps = function (t, e) {
					return t.getEnvelopeInternal().intersects(e.getEnvelopeInternal()) ? Ur.relate(t, e).isOverlaps(t.getDimension(), e.getDimension()) : !1
				}, Ur.disjoint = function (t, e) {
					return !t.intersects(e)
				}, Ur.relateWithCheck = function (t, e) {
					return t.checkNotGeometryCollection(t), t.checkNotGeometryCollection(e), Ur.relate(t, e)
				}, Ur.crosses = function (t, e) {
					return t.getEnvelopeInternal().intersects(e.getEnvelopeInternal()) ? Ur.relate(t, e).isCrosses(t.getDimension(), e.getDimension()) : !1
				}, Ur.contains = function (t, e) {
				...
				e(Yr.prototype, {
				...
				}, Yr.extractFactory = function (t) {
					return t.isEmpty() ? null : t.iterator().next().getFactory()
				}, Yr.createList = function () {
					if (2 === arguments.length) {
						var t = arguments[0],
							e = arguments[1],
							n = new I;
					...
					if (3 === arguments.length) {
						var n = arguments[0],
							i = arguments[1],
							r = arguments[2];
						return n.getSortIndex() === i ? r.add(n) : n instanceof gt && n.apply(new Hr(i, r)), r
					}
				}, e(Wr.prototype, {
				...
				e(Zr.prototype, {
					visitInteriorRing: function (t, e) {
						var n = t.getCoordinates(),
							...
							o = e.findEdgeEnd(s),
							a = null;
						o.getLabel().getLocation(0, cn.RIGHT) === L.INTERIOR ? a = o : o.getSym().getLabel().getLocation(0, cn.RIGHT) === L.INTERIOR && (a = o.getSym()), g.isTrue(null !== a, "unable to find dirEdge with Interior on RHS"), this.visitLinkedDirectedEdges(a)
					},
					...
					computeKey: function (t) {
						for (this.level = Qr.computeLevel(t), this.interval = new Kr, this.computeInterval(this.level, t); !this.interval.contains(t);) this.level += 1, this.computeInterval(this.level, t)
					},
				...
				e(gs.prototype, {
					...
					transformCoordinates: function (t, e) {
						var n = t.toCoordinateArray(),
							i = null;
						return i = 0 === n.length ? new Array(0).fill(null) : gs.simplify(n, this.distanceTolerance), this.factory.getCoordinateSequenceFactory().create(i)
					},
					transformMultiPolygon: function (t, e) {
						var n = xe.prototype.transformMultiPolygon.call(this, t, e);
						return this.createValidArea(n)
				...
				}), fs.DPTransformer = ds, h(ms, ce), e(ms.prototype, {
					getIndex: function () {
						return this.index
					},
					getParent: function () {
				...
				e(ws.prototype, {
					...
					visit: function (t) {
						for (var e = t[0].orig().getCoordinate(), n = t[1].orig().getCoordinate(), i = t[2].orig().getCoordinate(), r = ci.circumcentre(e, n, i), s = new bs(r), o = 0; 3 > o; o++) t[o].rot().setOrig(s)
					},
					interfaces_: function () {
						return [Ds]
					},
				...
				e(Js.prototype, {
					...
					equalsTopo: function (t) {
						return this.getEnvelopeInternal().equals(t.getEnvelopeInternal()) ? Ur.relate(this, t).isEquals(this.getDimension(), t.getDimension()) : !1
					},
					union: function () {
					...
					covers: function (t) {
						return Ur.covers(this, t)
					},
					coveredBy: function (t) {
						return Ur.coveredBy(this, t)
					},
					touches: function (t) {
						return Ur.touches(this, t)
					},
					intersects: function (t) {
						return Ur.intersects(this, t)
					},
					within: function (t) {
						return Ur.within(this, t)
					},
					overlaps: function (t) {
						return Ur.overlaps(this, t)
					},
					disjoint: function (t) {
						return Ur.disjoint(this, t)
					},
					crosses: function (t) {
						return Ur.crosses(this, t)
					},
					buffer: function () {
						if (1 === arguments.length) {
							var t = arguments[0];
		...
		18: [function (t, e, n) {
			...
			e.exports = function (t) {
				function e(t, e, i) {
					i ? n[e].coordinates = n[e].coordinates.concat(t.geometry.coordinates) : n[e].coordinates.push(t.geometry.coordinates), n[e].properties.push(t.properties)
				}
				var n = {
						MultiPoint: {
							coordinates: [],
				...
				return i.featureEach(t, function (t) {
					t.geometry && (n[t.geometry.type] ? e(t, t.geometry.type, !0) : r[t.geometry.type] && e(t, r[t.geometry.type], !1))
				}), {
					type: "FeatureCollection",
							...
							if (p !== m) {
								...
								if (v.boundary && !(v.lastVisited >= n)) {
									...
									if (v.lastVisited !== -n) {
										...
										var I = this.orient();
										if (I > 0) {
											y[x] = n, v.boundary = !1, l.push(v), c.push(v), v.lastVisited = n;
											continue
										}
										v.lastVisited = -n
									}
									...
									var L = N.indexOf(e);
									if (!(0 > L)) {
										N[L] = S, w[m] = v, C[p] = -1, w[p] = e, d[p] = S, S.flip();
										for (var E = 0; o >= E; ++E) {
											var R = C[E];
											if (!(0 > R || R === n)) {
		...
		41: [function (t, e, n) {
			...
			function c(t, e) {
				...
				for (var s = [], i = 0, a = e.length; a > i; ++i)
					for (var u = e[i], l = u.length, c = 1, g = 1 << l; g > c; ++c) {
			...
			var x = t("bit-twiddle"),
				E = t("union-find");
			n.dimension = i, n.countVertices = r, n.cloneCells = s, n.compareCells = o, n.normalize = u, n.unique = l, n.findCell = h, n.incidence = c, n.dual = g, n.explode = f, n.skeleton = d, n.boundary = m, n.connectedComponents = y
		}, {
			"bit-twiddle": 39,
			"union-find": 40
		}],
		...
		53: [function (t, e, n) {
			...
			e.exports = function (t, e, n) {
				...
				return r(2 * Math.atan2(Math.sqrt(g), Math.sqrt(1 - g)), n)
			}
		}, {
			"turf-helpers": 58,
			"turf-invariant": 54
		...
		57: [function (t, e, n) {
			var i = t("turf-meta").coordEach;
			e.exports = function (t) {
				return t = JSON.parse(JSON.stringify(t)), i(t, function (t) {
					t.reverse()
				}), t
			}
		}, {
		...
		64: [function (t, e, n) {
			...
			s.prototype.remove_seq = function (t) {
				...
				for (var m, p, v, y, x, E, I = function (t, e) {
						return (h[e] * g[t] - h[t] * g[e]) / (h[e] - h[t])
					}, N = function (t, e) {
						return (h[e] * f[t] - h[t] * f[e]) / (h[e] - h[t])
			...
			function i(t) {
				...
				for (var e = o(t), n = !1, i = 0; !n && i < t.features.length;) {
					...
					if ("Point" === v.type) e.geometry.coordinates[0] === v.coordinates[0] && e.geometry.coordinates[1] === v.coordinates[1] && (n = !0);
						...
						var x = !1;
						for (p = 0; !x && p < v.coordinates.length;) e.geometry.coordinates[0] === v.coordinates[p][0] && e.geometry.coordinates[1] === v.coordinates[p][1] && (n = !0, x = !0), p++
			...
			function a(t, e, n) {
				return t.map(function (t) {
					...
					for (var s = u(i, e, n).map(function (t) {
							return [t.x, t.y]
						}); !r(s);) e -= .01 * e, s = u(i, e, n).map(function (t) {
						return [t.x, t.y]
					});
		...
		86: [function (t, e, n) {
			...
			e.exports = function (t) {
				...
				return "Polygon" === t.geometry.type ? e.features = i(t.geometry.coordinates) : t.geometry.coordinates.forEach(function (t) {
					e.features = e.features.concat(i(t))
				}), e
			}
		}, {
			earcut: 87,
			...
			function o(t, e, n, i, r, c, g) {
				if (t) {
					...
					for (var f, d, p = t; t.prev !== t.next;)
						...
						g ? 1 === g ? (t = l(t, e, n), o(t, e, n, i, r, c, 2)) : 2 === g && h(t, e, n, i, r, c) : o(s(t), e, n, i, r, c, 1);
						break
					}
				}
			}
